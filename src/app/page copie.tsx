        ...
        <div className="max-w-7xl mx-auto animate-slideUp relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Titre principal */}
              <h1
                className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight tracking-tight animate-fadeInUp"
                style={{
              ...
              {/* Sous-titre */}
              <p
                className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto lg:mx-0 mb-16 leading-relaxed font-light animate-fadeInUp"
                style={{
                  fontFamily: "Inter, system-ui, sans-serif",
                  animationDelay: "0.2s",
                  lineHeight: "1.6",
              ...
              >
                🔥 The only system that helps DJs get real bookings, build real
                momentum & finally live from their music.
              </p>
              ...
              >
                <button
                  ...
                  style={{
                    boxShadow:
                      "0 15px 35px rgba(147, 51, 234, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.1)",
                  }}
                >
                  <span className="relative z-10">
                    Join Now - Save 100€ Today →
                  </span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 flex items-center justify-center gap-3">
              <Camera className="w-12 h-12 text-purple-600" /> Imagine This...
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                  <p className="text-base text-gray-600 italic font-medium">
                    "Tonight: DJ [YOUR NAME] live at Club XYZ 🔥"
                  </p>
                </div>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                  <p className="text-base text-gray-600 italic font-medium">
                    "VIP table, packed crowd, your music"
                  </p>
                </div>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                  <p className="text-base text-gray-600 italic font-medium">
                    "Bro your set was insane last night 🔥"
                  </p>
                </div>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                  <p className="text-base text-gray-600 italic font-medium">
                    "The crowd goes wild as you drop the beat 🎵"
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="aspect-video flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-white text-lg font-semibold">
                  Watch: From 0 to Booked in 90 Days
                </p>
                <p className="text-gray-400 text-sm mt-2">
                  Real DJ success story • 2:30 min
                </p>
              </div>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-purple-200 text-sm">
                See how our AI gives personalized advice
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-2xl mb-3">📱</div>
              ...
              <p className="text-purple-200 text-sm">
                Complete tour of all features & tools
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-2xl mb-3">🎯</div>
              ...
              <p className="text-purple-200 text-sm">
                DJs sharing their actual bookings
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Free Analysis Screenshot
                </h3>
                <p className="text-gray-600 text-sm">
                  See exactly how our AI analyzes your Spotify, Instagram &
                  TikTok to find your strengths
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Your exact step-by-step plan to get from 0 bookings to touring
                  DJ
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Get instant answers, booking templates, and personalized
                  advice anytime
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-purple-200 relative">
              <div className="absolute -top-4 left-8 bg-purple-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">
                1
              </div>
              <div className="text-center">
                <div className="mb-4">
                ...
                <p className="text-gray-600 mb-6">
                  We scan your Spotify, TikTok & Instagram to find your
                  strengths and gaps
                </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-200 relative">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Personalized PDF + platform access with your exact roadmap to
                  touring
                </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-green-200 relative">
              <div className="absolute -top-4 left-8 bg-green-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold">
                3
              </div>
              <div className="text-center">
                <div className="mb-4">
                ...
                <p className="text-gray-600 mb-6">
                  In 90 days, you'll have real bookings and your own tour poster
                </p>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-left max-w-2xl mx-auto space-y-6 text-lg leading-relaxed">
            ...
            <p className="text-gray-600">
              {" "}
              If you're not touring, not making money, not getting booked…
              <br /> It's not because you're not talented.{" "}
            </p>
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-xl text-gray-900">
                    Bedroom mixes → International shows
                  </h3>
                </div>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-gray-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-xl text-gray-900">
                    Unknown → Signing collabs with artists they love
                  </h3>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-16 p-8 bg-white rounded-2xl border-2 border-purple-300">
            <p className="text-2xl font-bold mb-4 text-gray-900 flex items-center justify-center gap-3">
              <Circle className="w-8 h-8 text-purple-600" /> The Truth:
            </p>
            <p className="text-xl text-gray-700">
              "Tous les autres te donnent des conseils flous.
              <br /> Nous, on te donne le plan exact + les bons contacts + un
              assistant AI."
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 text-xl text-gray-600">
                ...
                <p>
                  We help DJs build their tour, step-by-step, even if they're
        ...
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <div className="bg-white border-2 border-yellow-400 p-6 rounded-2xl mb-8">
            <p className="text-lg font-semibold text-gray-900">
              {" "}
              🛡️ Risk-free — If you don't get any tour in 1 year, we'll refund
              you.{" "}
            </p>
      ...
      <footer className="relative z-20 py-12 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 text-sm">
            © 2024 DJ Tour. All rights reserved.
          </p>
        </div>
      </footer>
