        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-gray-900 px-6 py-3 rounded-xl font-medium transition-all duration-200 hover:scale-105 shadow-lg"
            >
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="col-span-2 relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-2xl py-4 pl-12 pr-4 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all duration-200"
            />
          </div>
          <select
            value={statusFilter}
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-white/5 text-gray-500 hover:bg-red-500/10 hover:text-red-400 transition-colors"
                      ...
                      >
                        ...
                        <td className="py-4 px-6">
                          <div className="flex items-center justify-center gap-1">
                            ...
                            <button
                              onClick={() => deleteContact(contact.id)}
                              className="p-1.5 rounded-lg bg-white/5 text-gray-500 hover:bg-red-500/10 hover:text-red-400 transition-colors"
                              title="Supprimer le contact"
                            >
