...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 scale-50 origin-top-left">
      <DJSidebar />
