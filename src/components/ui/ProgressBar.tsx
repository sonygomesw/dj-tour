...
export function ProgressBar({
  ...
  return (
    <div
      className={cn(
        "relative w-full overflow-hidden rounded-full bg-gradient-to-r from-gray-100 to-gray-200",
    ...
    >
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-r from-violet-50 to-fuchsia-50 rounded-full"
      />{" "}
      {/* Progress bar with enhanced effects */}{" "}
      <motion.div
        initial={{ width: 0, opacity: 0 }}
        animate={{ width: `${clampedProgress}%`, opacity: 1 }}
        transition={{
        ...
        className={cn(
          ...
          color,
          glowEffect && "shadow-violet-500/50",
        )}
      >
        {" "}
        {/* Shimmer effect */}{" "}
      ...
      {showValue && (
        ...
        >
          {" "}
          <span className="text-xs font-bold text-gray-900 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
            {" "}
