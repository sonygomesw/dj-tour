          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center">
              ...
              <label
                ...
                className="bg-violet-500 hover:bg-violet-600 text-white px-4 py-2 rounded-lg cursor-pointer inline-flex items-center"
              >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <input
              ...
              value={presskitData.socialLinks.instagram}
              onChange={(e) => setPresskitData({
                ...presskitData,
            ...
            <input
              ...
              value={presskitData.socialLinks.soundcloud}
              onChange={(e) => setPresskitData({
                ...presskitData,
            ...
            <input
              ...
              value={presskitData.socialLinks.spotify}
              onChange={(e) => setPresskitData({
                ...presskitData,
