  ...
  return (
    <GlassContainer className="p-6 max-w-4xl mx-auto">
      <div className="space-y-6">
        ...
        {/* Tab Navigation */}
        <div className="flex justify-center space-x-2 bg-white/5 rounded-lg p-1">
          <button
        ...
        {activeTab === 'search' && (
          <div className="space-y-4">
            <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-violet-400 mb-2 flex items-center">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>Attend industry events to meet contacts in person</li>
            <li>Follow up regularly but don't be pushy</li>
          </ul>
        </div>
